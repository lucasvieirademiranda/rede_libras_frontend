...
class User extends React.Component {
    ...
    state = {
        columnDefs: [
            { headerName: "Nome", field: "name", editable: false, filter: "agTextColumnFilter", sortable: true, suppressMovable: true },
            { headerName: "Usuário", field: "user", editable: false, filter: "agTextColumnFilter", sortable: true, suppressMovable: true },
            { headerName: "E-Mail", field: "mail", editable: false, filter: "agTextColumnFilter", sortable: true, suppressMovable: true },
            { headerName: "", width: 100,  cellRenderer: function(event) { return buildControl('/users/edit/' + event.data.id, 'Editar', edit); } },
            { headerName: "", width: 100,  cellRenderer: function(event) { return buildControl('/users/delete/' + event.data.id, 'Remover', remove); } }
        ],
        rowData: [],
